...
export const SuccessToast = (message: ToastMessageProps["message"]) => {
...
export const ErrorToast = (message: ToastMessageProps["message"]) => {
  if (toastId) toast.dismiss(toastId); // Dismiss previous toast
...
export const WarningToast = (message: ToastMessageProps["message"]) => {
  if (toastId) toast.dismiss(toastId); // Dismiss previous toast
